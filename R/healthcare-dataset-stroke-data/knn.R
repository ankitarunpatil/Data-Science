...
barplot(countgender, main="Gender vs Stroke", xlab="Stroke Yes or No", col=c("blue","red"),legend=rownames(countgender))


counthypertension=table(smoke_data$hypertension,smoke_data$stroke)
barplot(counthypertension, main="Hypertension vs Stroke", xlab="Stroke Yes or No", col=c("blue","red"),legend=rownames(counthypertension))


countheart=table(smoke_data$heart_disease,smoke_data$stroke)
barplot(countheart, main="Heart Disease vs Stroke", xlab="Stroke Yes or No", col=c("blue","red"),legend=rownames(countheart))
...
boxplot(smoke_data$avg_glucose_level,smoke_data$bmi)
...
#Performing analysis with Anova
bmi =smoke_data$bmi
avg_glucose_level=smoke_data$avg_glucose_level
anovatt=lm(bmi~avg_glucose_level)
summary(anovatt)
